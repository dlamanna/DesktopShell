...
public static class ColorHandler
{
    ...
    {
        // HSV contains values scaled as in the color wheel: that is, all from 0 to 255. for ( this code to work, HSV.Hue needs to be scaled from 0 to 360 (it//s the angle of the selected
    ...
    {
        // In this function, R, G, and B values must be scaled to be between 0 and 1. HSV.Hue will be a value between 0 and 360, and HSV.Saturation and value are between 0 and 1.
